/**
 * Register `alibaba/dashscope-kimi-k2-6` — 新建 LLM 模型表单。
 */
'use client'
...
export default function AlibabaDashscopeKimiK26ModelForm(props: LlmRegisterFormProps) {
    ...
    const doc = DASHSCOPE_KIMI_K26_DOC
        ...
        <form className="grid gap-3" onSubmit={handleSubmit}>
            ...
            <fieldset className="fieldset">
                ...
                <input
                    ...
                    placeholder="设置列表中的名称（如「团队 Kimi」）"
                    value={displayName}
